...
instance Codec.Capnp.IsPtr (Type'anyPointer'unconstrained b) b where
...
instance Codec.Capnp.IsPtr (Brand b) b where
    fromPtr msg ptr = fmap Brand (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Method b) b where
    fromPtr msg ptr = fmap Method (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Enumerant b) b where
    fromPtr msg ptr = fmap Enumerant (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Field b) b where
    fromPtr msg ptr = fmap Field (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Superclass b) b where
    fromPtr msg ptr = fmap Superclass (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Brand'Scope b) b where
    fromPtr msg ptr = fmap Brand'Scope (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (CodeGeneratorRequest'RequestedFile'Import b) b where
    fromPtr msg ptr = fmap CodeGeneratorRequest'RequestedFile'Import (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Node'Parameter b) b where
    fromPtr msg ptr = fmap Node'Parameter (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Field'ordinal b) b where
    fromPtr = undefined -- TODO: define fromPtr for sums.
...
instance Codec.Capnp.IsPtr (CodeGeneratorRequest b) b where
    fromPtr msg ptr = fmap CodeGeneratorRequest (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Type'anyPointer b) b where
    fromPtr = undefined -- TODO: define fromPtr for sums.
...
instance Codec.Capnp.IsPtr (Brand'Binding b) b where
    fromPtr = undefined -- TODO: define fromPtr for sums.
data Value b
    = Value'void
    | Value'bool Bool
...
instance Codec.Capnp.IsPtr (Value b) b where
    fromPtr = undefined -- TODO: define fromPtr for sums.
...
instance Codec.Capnp.IsPtr (CodeGeneratorRequest'RequestedFile b) b where
    fromPtr msg ptr = fmap CodeGeneratorRequest'RequestedFile (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Type b) b where
    fromPtr = undefined -- TODO: define fromPtr for sums.
data ElementSize b
    = ElementSize'empty
    | ElementSize'bit
...
instance Codec.Capnp.IsPtr (Data.Capnp.Untyped.ListOf b (ElementSize b)) b where
...
instance Codec.Capnp.IsPtr (CapnpVersion b) b where
    fromPtr msg ptr = fmap CapnpVersion (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Node'NestedNode b) b where
    fromPtr msg ptr = fmap Node'NestedNode (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Node b) b where
    fromPtr msg ptr = fmap Node (Codec.Capnp.fromPtr msg ptr)
...
instance Codec.Capnp.IsPtr (Annotation b) b where
    fromPtr msg ptr = fmap Annotation (Codec.Capnp.fromPtr msg ptr)
