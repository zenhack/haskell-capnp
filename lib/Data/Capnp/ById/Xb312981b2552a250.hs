...
has_Call'questionId :: Call m b -> Bool
has_Call'questionId(Call struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Call'target :: Call m b -> Bool
has_Call'target(Call struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Call'interfaceId :: Call m b -> Bool
has_Call'interfaceId(Call struct) = 1 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Call'methodId :: Call m b -> Bool
has_Call'methodId(Call struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Call'params :: Call m b -> Bool
has_Call'params(Call struct) = 1 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Call'sendResultsTo :: Call m b -> Bool
has_Call'sendResultsTo(Call struct) = True
...
has_Call'allowThirdPartyTailCall :: Call m b -> Bool
has_Call'allowThirdPartyTailCall(Call struct) = 2 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Payload'content :: Payload m b -> Bool
has_Payload'content(Payload struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Payload'capTable :: Payload m b -> Bool
has_Payload'capTable(Payload struct) = 1 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Provide'questionId :: Provide m b -> Bool
has_Provide'questionId(Provide struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Provide'target :: Provide m b -> Bool
has_Provide'target(Provide struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Provide'recipient :: Provide m b -> Bool
has_Provide'recipient(Provide struct) = 1 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Return''answerId :: Return m b -> Bool
has_Return''answerId(Return struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Return''releaseParamCaps :: Return m b -> Bool
has_Return''releaseParamCaps(Return struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Return''union' :: Return m b -> Bool
has_Return''union'(Return struct) = True
data Return' (m :: * -> *) b
...
has_Release'id :: Release m b -> Bool
has_Release'id(Release struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Release'referenceCount :: Release m b -> Bool
has_Release'referenceCount(Release struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Resolve''promiseId :: Resolve m b -> Bool
has_Resolve''promiseId(Resolve struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Resolve''union' :: Resolve m b -> Bool
has_Resolve''union'(Resolve struct) = True
data Resolve' (m :: * -> *) b
...
has_ThirdPartyCapDescriptor'id :: ThirdPartyCapDescriptor m b -> Bool
has_ThirdPartyCapDescriptor'id(ThirdPartyCapDescriptor struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_ThirdPartyCapDescriptor'vineId :: ThirdPartyCapDescriptor m b -> Bool
has_ThirdPartyCapDescriptor'vineId(ThirdPartyCapDescriptor struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Finish'questionId :: Finish m b -> Bool
has_Finish'questionId(Finish struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Finish'releaseResultCaps :: Finish m b -> Bool
has_Finish'releaseResultCaps(Finish struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Accept'questionId :: Accept m b -> Bool
has_Accept'questionId(Accept struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Accept'provision :: Accept m b -> Bool
has_Accept'provision(Accept struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Accept'embargo :: Accept m b -> Bool
has_Accept'embargo(Accept struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Exception'reason :: Exception m b -> Bool
has_Exception'reason(Exception struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Exception'obsoleteIsCallersFault :: Exception m b -> Bool
has_Exception'obsoleteIsCallersFault(Exception struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Exception'obsoleteDurability :: Exception m b -> Bool
has_Exception'obsoleteDurability(Exception struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Exception'type_ :: Exception m b -> Bool
has_Exception'type_(Exception struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_PromisedAnswer'questionId :: PromisedAnswer m b -> Bool
has_PromisedAnswer'questionId(PromisedAnswer struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_PromisedAnswer'transform :: PromisedAnswer m b -> Bool
has_PromisedAnswer'transform(PromisedAnswer struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Bootstrap'questionId :: Bootstrap m b -> Bool
has_Bootstrap'questionId(Bootstrap struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Bootstrap'deprecatedObjectId :: Bootstrap m b -> Bool
has_Bootstrap'deprecatedObjectId(Bootstrap struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Disembargo'target :: Disembargo m b -> Bool
has_Disembargo'target(Disembargo struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Disembargo'context :: Disembargo m b -> Bool
has_Disembargo'context(Disembargo struct) = True
...
has_Join'questionId :: Join m b -> Bool
has_Join'questionId(Join struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.dataSection struct)
...
has_Join'target :: Join m b -> Bool
has_Join'target(Join struct) = 0 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)
...
has_Join'keyPart :: Join m b -> Bool
has_Join'keyPart(Join struct) = 1 < Data.Capnp.Untyped.length (Data.Capnp.Untyped.ptrSection struct)