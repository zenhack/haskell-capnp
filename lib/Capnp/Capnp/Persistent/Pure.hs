...
-}
module Capnp.Capnp.Persistent.Pure (Capnp.ById.Xb8630836983feed7.Persistent(..), Capnp.ById.Xb8630836983feed7.RealmGateway(..), Persistent'SaveParams(..), Persistent'SaveResults(..), RealmGateway'export'params(..), RealmGateway'import'params(..)
) where
