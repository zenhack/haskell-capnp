...
-}
module Capnp.Capnp.Persistent.Pure (Persistent(..), Persistent'server_(..),export_Persistent, RealmGateway(..), RealmGateway'server_(..),export_RealmGateway, Persistent'SaveParams(..), Persistent'SaveResults(..), RealmGateway'export'params(..), RealmGateway'import'params(..)
) where
