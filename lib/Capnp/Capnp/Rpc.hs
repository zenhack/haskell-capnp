...
instance U'.ReadCtx m msg => IsLabel "questionId" (DC'.Get (Call msg -> m Word32)) where
...
instance U'.ReadCtx m msg => IsLabel "questionId" (DC'.Has (Call msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "target" (DC'.Get (Call msg -> m (MessageTarget msg))) where
...
instance U'.ReadCtx m msg => IsLabel "target" (DC'.Has (Call msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "target" (DC'.Set (Call (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "interfaceId" (DC'.Get (Call msg -> m Word64)) where
...
instance U'.ReadCtx m msg => IsLabel "interfaceId" (DC'.Has (Call msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "methodId" (DC'.Get (Call msg -> m Word16)) where
...
instance U'.ReadCtx m msg => IsLabel "methodId" (DC'.Has (Call msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "params" (DC'.Get (Call msg -> m (Payload msg))) where
...
instance U'.ReadCtx m msg => IsLabel "params" (DC'.Has (Call msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "params" (DC'.Set (Call (M'.MutMsg s) -> (Payload (M'.MutMsg s)) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "sendResultsTo" (DC'.Get (Call msg -> m (Call'sendResultsTo msg))) where
...
instance U'.ReadCtx m msg => IsLabel "allowThirdPartyTailCall" (DC'.Get (Call msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "allowThirdPartyTailCall" (DC'.Has (Call msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (CapDescriptor msg -> m (CapDescriptor' msg))) where
    fromLabel = DC'.Get get_CapDescriptor'

has_CapDescriptor' :: U'.ReadCtx m msg => CapDescriptor msg -> m Bool
has_CapDescriptor'(CapDescriptor_newtype_ struct) = pure True
instance U'.ReadCtx m msg => IsLabel "" (DC'.Has (CapDescriptor msg -> m Bool)) where
...
set_CapDescriptor'receiverAnswer :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => CapDescriptor (M'.MutMsg s) -> (PromisedAnswer (M'.MutMsg s)) -> m ()
...
set_CapDescriptor'thirdPartyHosted :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => CapDescriptor (M'.MutMsg s) -> (ThirdPartyCapDescriptor (M'.MutMsg s)) -> m ()
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (Message msg -> m (Message' msg))) where
    fromLabel = DC'.Get get_Message'

has_Message' :: U'.ReadCtx m msg => Message msg -> m Bool
has_Message'(Message_newtype_ struct) = pure True
instance U'.ReadCtx m msg => IsLabel "" (DC'.Has (Message msg -> m Bool)) where
    fromLabel = DC'.Has has_Message'


set_Message'unimplemented :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Message (M'.MutMsg s)) -> m ()
set_Message'unimplemented(Message_newtype_ struct) value = do
    C'.setWordField struct (0 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'abort :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Exception (M'.MutMsg s)) -> m ()
set_Message'abort(Message_newtype_ struct) value = do
    C'.setWordField struct (1 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'call :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Call (M'.MutMsg s)) -> m ()
set_Message'call(Message_newtype_ struct) value = do
    C'.setWordField struct (2 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'return :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Return (M'.MutMsg s)) -> m ()
set_Message'return(Message_newtype_ struct) value = do
    C'.setWordField struct (3 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'finish :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Finish (M'.MutMsg s)) -> m ()
set_Message'finish(Message_newtype_ struct) value = do
    C'.setWordField struct (4 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'resolve :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Resolve (M'.MutMsg s)) -> m ()
set_Message'resolve(Message_newtype_ struct) value = do
    C'.setWordField struct (5 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'release :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Release (M'.MutMsg s)) -> m ()
set_Message'release(Message_newtype_ struct) value = do
    C'.setWordField struct (6 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'obsoleteSave :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ()
set_Message'obsoleteSave(Message_newtype_ struct) value = do
    C'.setWordField struct (7 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'bootstrap :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Bootstrap (M'.MutMsg s)) -> m ()
set_Message'bootstrap(Message_newtype_ struct) value = do
    C'.setWordField struct (8 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'obsoleteDelete :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ()
set_Message'obsoleteDelete(Message_newtype_ struct) value = do
    C'.setWordField struct (9 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'provide :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Provide (M'.MutMsg s)) -> m ()
set_Message'provide(Message_newtype_ struct) value = do
    C'.setWordField struct (10 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'accept :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Accept (M'.MutMsg s)) -> m ()
set_Message'accept(Message_newtype_ struct) value = do
    C'.setWordField struct (11 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'join :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Join (M'.MutMsg s)) -> m ()
set_Message'join(Message_newtype_ struct) value = do
    C'.setWordField struct (12 :: Word16) 0 0 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Message'disembargo :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Message (M'.MutMsg s) -> (Disembargo (M'.MutMsg s)) -> m ()
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (MessageTarget msg -> m (MessageTarget' msg))) where
    fromLabel = DC'.Get get_MessageTarget'
...
set_MessageTarget'promisedAnswer :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => MessageTarget (M'.MutMsg s) -> (PromisedAnswer (M'.MutMsg s)) -> m ()
...
instance U'.ReadCtx m msg => IsLabel "content" (DC'.Get (Payload msg -> m (Maybe (U'.Ptr msg)))) where
...
instance U'.ReadCtx m msg => IsLabel "content" (DC'.Has (Payload msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "content" (DC'.Set (Payload (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "capTable" (DC'.Get (Payload msg -> m (B'.List msg (CapDescriptor msg)))) where
...
instance U'.ReadCtx m msg => IsLabel "capTable" (DC'.Has (Payload msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "capTable" (DC'.Set (Payload (M'.MutMsg s) -> (B'.List (M'.MutMsg s) (CapDescriptor (M'.MutMsg s))) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "questionId" (DC'.Get (Provide msg -> m Word32)) where
...
instance U'.ReadCtx m msg => IsLabel "questionId" (DC'.Has (Provide msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "target" (DC'.Get (Provide msg -> m (MessageTarget msg))) where
...
instance U'.ReadCtx m msg => IsLabel "target" (DC'.Has (Provide msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "target" (DC'.Set (Provide (M'.MutMsg s) -> (MessageTarget (M'.MutMsg s)) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "recipient" (DC'.Get (Provide msg -> m (Maybe (U'.Ptr msg)))) where
...
instance U'.ReadCtx m msg => IsLabel "recipient" (DC'.Has (Provide msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "recipient" (DC'.Set (Provide (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "answerId" (DC'.Get (Return msg -> m Word32)) where
...
instance U'.ReadCtx m msg => IsLabel "answerId" (DC'.Has (Return msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "releaseParamCaps" (DC'.Get (Return msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "releaseParamCaps" (DC'.Has (Return msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "union'" (DC'.Get (Return msg -> m (Return' msg))) where
...
instance U'.ReadCtx m msg => IsLabel "id" (DC'.Get (ThirdPartyCapDescriptor msg -> m (Maybe (U'.Ptr msg)))) where
...
instance U'.ReadCtx m msg => IsLabel "id" (DC'.Has (ThirdPartyCapDescriptor msg -> m Bool)) where
...
instance (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => IsLabel "id" (DC'.Set (ThirdPartyCapDescriptor (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ())) where
...
instance U'.ReadCtx m msg => IsLabel "vineId" (DC'.Get (ThirdPartyCapDescriptor msg -> m Word32)) where
...
instance U'.ReadCtx m msg => IsLabel "vineId" (DC'.Has (ThirdPartyCapDescriptor msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (Call'sendResultsTo msg -> m (Call'sendResultsTo' msg))) where
    fromLabel = DC'.Get get_Call'sendResultsTo'
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Has (Call'sendResultsTo msg -> m Bool)) where
    fromLabel = DC'.Has has_Call'sendResultsTo'
...
set_Call'sendResultsTo'thirdParty :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Call'sendResultsTo (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ()
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (Disembargo'context msg -> m (Disembargo'context' msg))) where
    fromLabel = DC'.Get get_Disembargo'context'
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (PromisedAnswer'Op msg -> m (PromisedAnswer'Op' msg))) where
    fromLabel = DC'.Get get_PromisedAnswer'Op'
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Has (PromisedAnswer'Op msg -> m Bool)) where
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (Resolve' msg -> m (Resolve'' msg))) where
    fromLabel = DC'.Get get_Resolve''
...
set_Resolve'cap :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Resolve' (M'.MutMsg s) -> (CapDescriptor (M'.MutMsg s)) -> m ()
set_Resolve'cap(Resolve'_newtype_ struct) value = do
    C'.setWordField struct (0 :: Word16) 0 32 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Resolve'exception :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Resolve' (M'.MutMsg s) -> (Exception (M'.MutMsg s)) -> m ()
...
instance U'.ReadCtx m msg => IsLabel "" (DC'.Get (Return' msg -> m (Return'' msg))) where
    fromLabel = DC'.Get get_Return''
...
set_Return'results :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Return' (M'.MutMsg s) -> (Payload (M'.MutMsg s)) -> m ()
set_Return'results(Return'_newtype_ struct) value = do
    C'.setWordField struct (0 :: Word16) 0 48 0
    U'.setPtr (C'.toPtr value) 0 struct

set_Return'exception :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Return' (M'.MutMsg s) -> (Exception (M'.MutMsg s)) -> m ()
...
set_Return'acceptFromThirdParty :: (U'.ReadCtx m (M'.MutMsg s), M'.WriteCtx m s) => Return' (M'.MutMsg s) -> (Maybe (U'.Ptr (M'.MutMsg s))) -> m ()
