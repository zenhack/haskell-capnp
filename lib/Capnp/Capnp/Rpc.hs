...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Call m BS.ByteString) Call where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Call BS.ByteString where
    fromStruct struct = do
        ...
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Call m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.CapDescriptor m BS.ByteString) CapDescriptor where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m CapDescriptor BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.CapDescriptor m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Message m BS.ByteString) Message where
    decerialize raw = case raw of
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Message BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Message m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.MessageTarget m BS.ByteString) MessageTarget where
    decerialize raw = case raw of
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m MessageTarget BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.MessageTarget m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Payload m BS.ByteString) Payload where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Payload BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Payload m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Provide m BS.ByteString) Provide where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Provide BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Provide m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Return m BS.ByteString) Return where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Return BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Return m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Release m BS.ByteString) Release where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Release BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Release m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Exception'Type m BS.ByteString) Exception'Type where
    decerialize raw = case raw of
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Resolve m BS.ByteString) Resolve where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Resolve BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Resolve m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.ThirdPartyCapDescriptor m BS.ByteString) ThirdPartyCapDescriptor where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m ThirdPartyCapDescriptor BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.ThirdPartyCapDescriptor m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Finish m BS.ByteString) Finish where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Finish BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Finish m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Accept m BS.ByteString) Accept where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Accept BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Accept m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Disembargo'context m BS.ByteString) Disembargo'context where
    decerialize raw = case raw of
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Disembargo'context BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Disembargo'context m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Exception m BS.ByteString) Exception where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Exception BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Exception m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.PromisedAnswer m BS.ByteString) PromisedAnswer where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m PromisedAnswer BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.PromisedAnswer m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Call'sendResultsTo m BS.ByteString) Call'sendResultsTo where
    decerialize raw = case raw of
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Call'sendResultsTo BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Call'sendResultsTo m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Bootstrap m BS.ByteString) Bootstrap where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Bootstrap BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Bootstrap m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.PromisedAnswer'Op m BS.ByteString) PromisedAnswer'Op where
    decerialize raw = case raw of
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m PromisedAnswer'Op BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.PromisedAnswer'Op m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Disembargo m BS.ByteString) Disembargo where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Disembargo BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Disembargo m BS.ByteString)
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.Decerialize m (Capnp.ById.Xb312981b2552a250.Join m BS.ByteString) Join where
...
instance (MonadThrow m, MonadLimit m) => Codec.Capnp.IsStruct m Join BS.ByteString where
    fromStruct struct = do
        raw <- Codec.Capnp.fromStruct struct
        Codec.Capnp.decerialize (raw :: Capnp.ById.Xb312981b2552a250.Join m BS.ByteString)
