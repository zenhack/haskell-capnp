   ...
   in [ DcData
        ...
        let ctx =
         ...
         in instance_
              ...
              ["Classes"]
              "FromStruct"
              [TVar "mut", containerTypeType (TVar "mut")]
   ...
   in [ DcData
        ...
        instance_
          ...
          [ IdData
            ...
            iValue "index" [PVar "i", PLCtor listCtor [PVar "l"]] $
              EFApp
                (egName ["Classes"] "fromWord")
                [ EFApp
                    (eStd_ "fromIntegral")
            ...
            iValue "listFromPtr" [PVar "msg", PVar "ptr"] $
              EFApp
                (ELName listCtor)
                [ EApp
                    (egName ["Classes"] "fromPtr")
            ...
            iValue "toUntypedList" [PLCtor listCtor [PVar "l"]] $
              EApp
                (egName ["Untyped"] "List16")
                [ELName "l"],
            iValue "length" [PLCtor listCtor [PVar "l"]] $
              EApp
        ...
        instance_
          ...
          [ iValue
            ...
            iValue "newList" [PVar "msg", PVar "size"] $
              EFApp
                (ELName listCtor)
                [ EApp
...
declToDecls _thisMod Raw.InterfaceWrapper {typeCtor, typeParams} =
  let dataCtor = Name.mkSub typeCtor "newtype_"
   in [ newtypeWrapper typeCtor (map Name.typeVarName typeParams ++ ["msg"]) $
          TApp
            (tStd_ "Maybe")
            [ TApp
                (tgName ["Untyped"] "Cap")
        ...
        instance_
          ...
          [ iValue
              "toPtr"
              [PVar "msg", PLCtor dataCtor [PGCtor (std_ "Nothing") []]]
              (EApp (eStd_ "pure") [eStd_ "Nothing"]),
            iValue
              "toPtr"
              [PVar "msg", PLCtor dataCtor [PGCtor (std_ "Just") [PVar "cap"]]]
              ( EApp
                  (eStd_ "pure")
                  [ EApp
                      (eStd_ "Just")
  ...
  let dataCtor = Name.mkSub typeCtor "newtype_"
   ...
   in [ newtypeWrapper typeCtor (map Name.typeVarName typeParams ++ ["msg"]) $
        ...
        instance_
          ...
          ["Classes"]
          "FromStruct"
          [TVar "msg", containerTypeType (TVar "msg")]
          [ iValue "fromStruct" [PVar "struct"] $
              EApp
                (eStd_ "pure")
        ...
        instance_
          ...
          ["Untyped"]
          "HasMessage"
          [containerTypeType (TVar "mut"), TVar "mut"]
          [ iValue
              "message"
              [PLCtor dataCtor [PVar "struct"]]
        ...
        instance_
          ...
          "MessageDefault"
          [containerTypeType (TVar "mut"), TVar "mut"]
          [ iValue "messageDefault" [PVar "msg"] $
              EFApp
                (ELName dataCtor)
                [ EApp
...
declToDecls _thisMod Raw.StructInstances {typeCtor, typeParams, dataWordCount, pointerCount} =
  let listCtor = Name.mkSub typeCtor "List_"
      ...
      containerTypeType = containerTypeToType typeCtor typeParams
   in [ wrapperFromPtr typeCtor typeParams dataCtor,
        instance_
          []
          ["Classes"]
          "ToPtr"
        ...
        instance_
          ...
          [ iValue
            ...
            iValue "newList" [PVar "msg", PVar "len"] $
              EFApp
                (ELName listCtor)
                [ EApp
...
wrapperFromPtr typeCtor typeParams dataCtor =
  instance_
    ...
    [ iValue "fromPtr" [PVar "msg", PVar "ptr"] $
        EFApp
          (ELName dataCtor)
          [ EApp
              (egName ["Classes"] "fromPtr")
