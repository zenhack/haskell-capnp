...
instance (OL.IsLabel "id" (F.Field (Node) Std_.Word64))
instance (F.HasField "id" (Node) Std_.Word64)
instance (OL.IsLabel "displayName" (F.Field (Node) Basics.Text))
instance (F.HasField "displayName" (Node) Basics.Text)
instance (OL.IsLabel "displayNamePrefixLength" (F.Field (Node) Std_.Word32))
instance (F.HasField "displayNamePrefixLength" (Node) Std_.Word32)
instance (OL.IsLabel "scopeId" (F.Field (Node) Std_.Word64))
instance (F.HasField "scopeId" (Node) Std_.Word64)
instance (OL.IsLabel "nestedNodes" (F.Field (Node) (R.List Node'NestedNode)))
instance (F.HasField "nestedNodes" (Node) (R.List Node'NestedNode))
instance (OL.IsLabel "annotations" (F.Field (Node) (R.List Annotation)))
instance (F.HasField "annotations" (Node) (R.List Annotation))
instance (OL.IsLabel "parameters" (F.Field (Node) (R.List Node'Parameter)))
instance (F.HasField "parameters" (Node) (R.List Node'Parameter))
instance (OL.IsLabel "isGeneric" (F.Field (Node) Std_.Bool))
instance (F.HasField "isGeneric" (Node) Std_.Bool)
data Node'struct 
type instance (R.ReprFor Node'struct) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "dataWordCount" (F.Field (Node'struct) Std_.Word16))
instance (F.HasField "dataWordCount" (Node'struct) Std_.Word16)
instance (OL.IsLabel "pointerCount" (F.Field (Node'struct) Std_.Word16))
instance (F.HasField "pointerCount" (Node'struct) Std_.Word16)
instance (OL.IsLabel "preferredListEncoding" (F.Field (Node'struct) ElementSize))
instance (F.HasField "preferredListEncoding" (Node'struct) ElementSize)
instance (OL.IsLabel "isGroup" (F.Field (Node'struct) Std_.Bool))
instance (F.HasField "isGroup" (Node'struct) Std_.Bool)
instance (OL.IsLabel "discriminantCount" (F.Field (Node'struct) Std_.Word16))
instance (F.HasField "discriminantCount" (Node'struct) Std_.Word16)
instance (OL.IsLabel "discriminantOffset" (F.Field (Node'struct) Std_.Word32))
instance (F.HasField "discriminantOffset" (Node'struct) Std_.Word32)
instance (OL.IsLabel "fields" (F.Field (Node'struct) (R.List Field)))
instance (F.HasField "fields" (Node'struct) (R.List Field))
data Node'enum 
type instance (R.ReprFor Node'enum) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "enumerants" (F.Field (Node'enum) (R.List Enumerant)))
instance (F.HasField "enumerants" (Node'enum) (R.List Enumerant))
data Node'interface 
type instance (R.ReprFor Node'interface) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "methods" (F.Field (Node'interface) (R.List Method)))
instance (F.HasField "methods" (Node'interface) (R.List Method))
instance (OL.IsLabel "superclasses" (F.Field (Node'interface) (R.List Superclass)))
...
instance (OL.IsLabel "type_" (F.Field (Node'const) Type))
instance (F.HasField "type_" (Node'const) Type)
instance (OL.IsLabel "value" (F.Field (Node'const) Value))
...
instance (OL.IsLabel "type_" (F.Field (Node'annotation) Type))
instance (F.HasField "type_" (Node'annotation) Type)
instance (OL.IsLabel "targetsFile" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsFile" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsConst" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsConst" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsEnum" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsEnum" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsEnumerant" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsEnumerant" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsStruct" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsStruct" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsField" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsField" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsUnion" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsUnion" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsGroup" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsGroup" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsInterface" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsInterface" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsMethod" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsMethod" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsParam" (F.Field (Node'annotation) Std_.Bool))
instance (F.HasField "targetsParam" (Node'annotation) Std_.Bool)
instance (OL.IsLabel "targetsAnnotation" (F.Field (Node'annotation) Std_.Bool))
...
instance (OL.IsLabel "name" (F.Field (Node'Parameter) Basics.Text))
...
instance (OL.IsLabel "name" (F.Field (Node'NestedNode) Basics.Text))
instance (F.HasField "name" (Node'NestedNode) Basics.Text)
instance (OL.IsLabel "id" (F.Field (Node'NestedNode) Std_.Word64))
...
instance (OL.IsLabel "id" (F.Field (Node'SourceInfo) Std_.Word64))
instance (F.HasField "id" (Node'SourceInfo) Std_.Word64)
instance (OL.IsLabel "docComment" (F.Field (Node'SourceInfo) Basics.Text))
instance (F.HasField "docComment" (Node'SourceInfo) Basics.Text)
instance (OL.IsLabel "members" (F.Field (Node'SourceInfo) (R.List Node'SourceInfo'Member)))
...
instance (OL.IsLabel "name" (F.Field (Enumerant) Basics.Text))
instance (F.HasField "name" (Enumerant) Basics.Text)
instance (OL.IsLabel "codeOrder" (F.Field (Enumerant) Std_.Word16))
instance (F.HasField "codeOrder" (Enumerant) Std_.Word16)
instance (OL.IsLabel "annotations" (F.Field (Enumerant) (R.List Annotation)))
instance (F.HasField "annotations" (Enumerant) (R.List Annotation))
data Superclass 
type instance (R.ReprFor Superclass) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "id" (F.Field (Superclass) Std_.Word64))
instance (F.HasField "id" (Superclass) Std_.Word64)
instance (OL.IsLabel "brand" (F.Field (Superclass) Brand))
instance (F.HasField "brand" (Superclass) Brand)
data Method 
type instance (R.ReprFor Method) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "name" (F.Field (Method) Basics.Text))
instance (F.HasField "name" (Method) Basics.Text)
instance (OL.IsLabel "codeOrder" (F.Field (Method) Std_.Word16))
instance (F.HasField "codeOrder" (Method) Std_.Word16)
instance (OL.IsLabel "paramStructType" (F.Field (Method) Std_.Word64))
instance (F.HasField "paramStructType" (Method) Std_.Word64)
instance (OL.IsLabel "resultStructType" (F.Field (Method) Std_.Word64))
instance (F.HasField "resultStructType" (Method) Std_.Word64)
instance (OL.IsLabel "annotations" (F.Field (Method) (R.List Annotation)))
instance (F.HasField "annotations" (Method) (R.List Annotation))
instance (OL.IsLabel "paramBrand" (F.Field (Method) Brand))
instance (F.HasField "paramBrand" (Method) Brand)
instance (OL.IsLabel "resultBrand" (F.Field (Method) Brand))
instance (F.HasField "resultBrand" (Method) Brand)
instance (OL.IsLabel "implicitParameters" (F.Field (Method) (R.List Node'Parameter)))
...
instance (OL.IsLabel "scopeId" (F.Field (Type'anyPointer'parameter) Std_.Word64))
instance (F.HasField "scopeId" (Type'anyPointer'parameter) Std_.Word64)
instance (OL.IsLabel "parameterIndex" (F.Field (Type'anyPointer'parameter) Std_.Word16))
...
instance (OL.IsLabel "parameterIndex" (F.Field (Type'anyPointer'implicitMethodParameter) Std_.Word16))
...
instance (OL.IsLabel "scopes" (F.Field (Brand) (R.List Brand'Scope)))
instance (F.HasField "scopes" (Brand) (R.List Brand'Scope))
data Brand'Scope 
type instance (R.ReprFor Brand'Scope) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "scopeId" (F.Field (Brand'Scope) Std_.Word64))
...
instance (OL.IsLabel "id" (F.Field (Annotation) Std_.Word64))
instance (F.HasField "id" (Annotation) Std_.Word64)
instance (OL.IsLabel "value" (F.Field (Annotation) Value))
instance (F.HasField "value" (Annotation) Value)
instance (OL.IsLabel "brand" (F.Field (Annotation) Brand))
...
instance (OL.IsLabel "major" (F.Field (CapnpVersion) Std_.Word16))
instance (F.HasField "major" (CapnpVersion) Std_.Word16)
instance (OL.IsLabel "minor" (F.Field (CapnpVersion) Std_.Word8))
instance (F.HasField "minor" (CapnpVersion) Std_.Word8)
instance (OL.IsLabel "micro" (F.Field (CapnpVersion) Std_.Word8))
...
instance (OL.IsLabel "nodes" (F.Field (CodeGeneratorRequest) (R.List Node)))
instance (F.HasField "nodes" (CodeGeneratorRequest) (R.List Node))
instance (OL.IsLabel "requestedFiles" (F.Field (CodeGeneratorRequest) (R.List CodeGeneratorRequest'RequestedFile)))
instance (F.HasField "requestedFiles" (CodeGeneratorRequest) (R.List CodeGeneratorRequest'RequestedFile))
instance (OL.IsLabel "capnpVersion" (F.Field (CodeGeneratorRequest) CapnpVersion))
instance (F.HasField "capnpVersion" (CodeGeneratorRequest) CapnpVersion)
instance (OL.IsLabel "sourceInfo" (F.Field (CodeGeneratorRequest) (R.List Node'SourceInfo)))
...
instance (OL.IsLabel "id" (F.Field (CodeGeneratorRequest'RequestedFile) Std_.Word64))
instance (F.HasField "id" (CodeGeneratorRequest'RequestedFile) Std_.Word64)
instance (OL.IsLabel "filename" (F.Field (CodeGeneratorRequest'RequestedFile) Basics.Text))
instance (F.HasField "filename" (CodeGeneratorRequest'RequestedFile) Basics.Text)
instance (OL.IsLabel "imports" (F.Field (CodeGeneratorRequest'RequestedFile) (R.List CodeGeneratorRequest'RequestedFile'Import)))
...
instance (OL.IsLabel "id" (F.Field (CodeGeneratorRequest'RequestedFile'Import) Std_.Word64))
instance (F.HasField "id" (CodeGeneratorRequest'RequestedFile'Import) Std_.Word64)
instance (OL.IsLabel "name" (F.Field (CodeGeneratorRequest'RequestedFile'Import) Basics.Text))
