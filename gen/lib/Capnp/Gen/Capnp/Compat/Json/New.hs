...
instance (OL.IsLabel "name" (F.Field (DiscriminatorOptions) Basics.Text))
instance (F.HasField "name" (DiscriminatorOptions) Basics.Text)
instance (OL.IsLabel "valueName" (F.Field (DiscriminatorOptions) Basics.Text))
