...
instance (OL.IsLabel "questionId" (F.Field (Bootstrap) Std_.Word32))
instance (F.HasField "questionId" (Bootstrap) Std_.Word32)
instance (OL.IsLabel "deprecatedObjectId" (F.Field (Bootstrap) Basics.AnyPointer))
instance (F.HasField "deprecatedObjectId" (Bootstrap) Basics.AnyPointer)
data Call 
type instance (R.ReprFor Call) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "questionId" (F.Field (Call) Std_.Word32))
instance (F.HasField "questionId" (Call) Std_.Word32)
instance (OL.IsLabel "target" (F.Field (Call) MessageTarget))
instance (F.HasField "target" (Call) MessageTarget)
instance (OL.IsLabel "interfaceId" (F.Field (Call) Std_.Word64))
instance (F.HasField "interfaceId" (Call) Std_.Word64)
instance (OL.IsLabel "methodId" (F.Field (Call) Std_.Word16))
instance (F.HasField "methodId" (Call) Std_.Word16)
instance (OL.IsLabel "params" (F.Field (Call) Payload))
instance (F.HasField "params" (Call) Payload)
instance (OL.IsLabel "sendResultsTo" (F.Field (Call) Call'sendResultsTo))
instance (F.HasField "sendResultsTo" (Call) Call'sendResultsTo)
instance (OL.IsLabel "allowThirdPartyTailCall" (F.Field (Call) Std_.Bool))
...
instance (OL.IsLabel "questionId" (F.Field (Provide) Std_.Word32))
instance (F.HasField "questionId" (Provide) Std_.Word32)
instance (OL.IsLabel "target" (F.Field (Provide) MessageTarget))
instance (F.HasField "target" (Provide) MessageTarget)
instance (OL.IsLabel "recipient" (F.Field (Provide) Basics.AnyPointer))
instance (F.HasField "recipient" (Provide) Basics.AnyPointer)
data Accept 
type instance (R.ReprFor Accept) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "questionId" (F.Field (Accept) Std_.Word32))
instance (F.HasField "questionId" (Accept) Std_.Word32)
instance (OL.IsLabel "provision" (F.Field (Accept) Basics.AnyPointer))
instance (F.HasField "provision" (Accept) Basics.AnyPointer)
instance (OL.IsLabel "embargo" (F.Field (Accept) Std_.Bool))
instance (F.HasField "embargo" (Accept) Std_.Bool)
data Join 
type instance (R.ReprFor Join) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "questionId" (F.Field (Join) Std_.Word32))
instance (F.HasField "questionId" (Join) Std_.Word32)
instance (OL.IsLabel "target" (F.Field (Join) MessageTarget))
instance (F.HasField "target" (Join) MessageTarget)
instance (OL.IsLabel "keyPart" (F.Field (Join) Basics.AnyPointer))
...
instance (OL.IsLabel "id" (F.Field (ThirdPartyCapDescriptor) Basics.AnyPointer))
instance (F.HasField "id" (ThirdPartyCapDescriptor) Basics.AnyPointer)
instance (OL.IsLabel "vineId" (F.Field (ThirdPartyCapDescriptor) Std_.Word32))
instance (F.HasField "vineId" (ThirdPartyCapDescriptor) Std_.Word32)
data Exception 
type instance (R.ReprFor Exception) = (R.Ptr (Std_.Just R.Struct))
instance (OL.IsLabel "reason" (F.Field (Exception) Basics.Text))
instance (F.HasField "reason" (Exception) Basics.Text)
instance (OL.IsLabel "obsoleteIsCallersFault" (F.Field (Exception) Std_.Bool))
instance (F.HasField "obsoleteIsCallersFault" (Exception) Std_.Bool)
instance (OL.IsLabel "obsoleteDurability" (F.Field (Exception) Std_.Word16))
instance (F.HasField "obsoleteDurability" (Exception) Std_.Word16)
instance (OL.IsLabel "type_" (F.Field (Exception) Exception'Type))
